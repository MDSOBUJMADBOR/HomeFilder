...
// 🛠️ HeroUI সর্টের জন্য টাইপ ডিক্লেয়ারেশন
interface CustomSortDescriptor {
  column: keyof Book | "date";
...
export default function BookApprovalQueue() {
  ...
  // 🛠️ FIX: স্টেটের সুনির্দিষ্ট কাস্টম টাইপ বলে দেওয়া হয়েছে যেন 'date' কলামও সাপোর্ট করে

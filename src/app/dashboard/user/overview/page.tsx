...
export default function AdminOverviewPage() {
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        const [houseRes, myHouseRes] = await Promise.all([
        ...
        <div className="rounded-2xl bg-white p-4 sm:p-6 shadow-lg">
          ...
          <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div className="rounded-xl bg-blue-50 p-6 text-center shadow-sm">
              ...
              <p className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-600">
                {stats.houses}
              </p>
            </div>
            ...
            <div className="rounded-xl bg-green-50 p-6 text-center shadow-sm">
              ...
              <p className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold text-green-600">
                {stats.myHouses}
              </p>
            </div>
          </div>
